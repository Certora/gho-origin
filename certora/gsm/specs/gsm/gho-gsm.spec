...
rule enoughULtoBackGhoBuyAsset() {
  ...
  uint256 _ghoMinted; uint256 _ghoLimit;
  (_ghoLimit,_ghoMinted) = _ghoReserve.getUsage(currentContract);
  ...
  uint256 ghoMinted_; uint256 ghoLimit_;
  (ghoLimit_,ghoMinted_) = _ghoReserve.getUsage(currentContract);
